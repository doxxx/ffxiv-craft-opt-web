...
XIVDB.prototype.getServers = function () {
  return XIV_SERVERS;
};

XIVDB.prototype.search = function (name, server) {
...
XIVDB.prototype.getCharacter = function (id) {
...
angular.module('ffxivCraftOptWeb.services.xivdb', []).
  service('_xivdb', XIVDB);
